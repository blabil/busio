    ...
    <div className='ml-3 h-screen md:overflow-hidden overflow-auto md:hover:overflow-auto pb-10'>
      {activeMenu && (<>
        ...
        <Link to='/' className='items-center gap-3 ml-3 mt-4 flex text-xl font-extrabold tracking-tight dark:text-white text-slate-900'>
          ...
          <TooltipComponent content="Zamknij menu" position='BottomCenter'>
            <button type='button' onClick={() => { setActiveMenu((prevActiveMenu) => !prevActiveMenu) }} className='text-xl rounded-full pd-3 hover:bg-light-gray mt-5 mr-4 block'>
               <MdOutlineCancel/>
            </button>
          </TooltipComponent>
      </div>
